...
function About() {
    ...
    return (
        <div>
            <section className="relative w-full min-h-dvh bg-black">
                <Iridescence className="absolute inset-0 z-0"/>
                <div className="relative z-10 p-6 sm:p-10 pb-[24vh] lg:pb-[30vh]">
                    ...
                    <div className="mx-auto max-w-screen-md">
                        ...
                        <div className="mt-6 lg:mt-0 relative isolate min-h-40 md:min-h-48 lg:min-h-56">
